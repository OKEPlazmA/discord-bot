...
exports.messageAuthor = function(message, prefix) {
    ...
    if (message.content.startsWith(prefix + 'help')) {
        message.author.sendMessage("If you want to search stackoverflow.com put a '!S' in the beginning of your search.");
    ...
    if (message.content.startsWith(prefix + 'courses')) {
        ...
        message.author.sendMessage("https://www.udemy.com/ultimate-web/");
        message.author.sendMessage("https://www.udemy.com/swift-kitura/");
        message.author.sendMessage("https://www.udemy.com/blender3d/");
