...
bot.on('message', function(message) {
    ...
    functionHelper.checkConditions([devslopesCourses], message, "You can find more Devslopes courses from https://devslopes.com/courses");
    functionHelper.checkConditions([devslopesSubscription], message, "You can purchase a subscription for all Devslopes courses from here https://devslopes.com/subscribe");
